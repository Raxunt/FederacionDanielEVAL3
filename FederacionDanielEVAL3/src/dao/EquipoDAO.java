...
public class EquipoDAO implements operacionesCRUD<Equipo>{
	...
	public boolean insertarConID(Equipo a) {
		...
		try {
			...
			//pstmt.setLong(1, a.getEquipo().getID());
			//pstmt.setString(2, a.getAniosInscripcion().getInt());
			//pstmt.setString(3, a.getManager().getId());
...
//	@Override
//	public long insertarSinID(Equipo a) {
//		long ret = -1;
...
//								if (idatleta != -1) {
//									System.out.println(
//											"Se ha insertado correctamente el nuevo Equipo de id: " + idatleta);
//									if (conex != null)
//										conex.close();
//									return idatleta;
							//	}
